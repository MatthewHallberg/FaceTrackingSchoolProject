(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function drawGlasses(dimensions, canvas, results) {
       ...
       const drawLandmarksOptions = {
        ...
        faceLandmarksArray.forEach(function (landmarks) {
            if (drawLines && landmarks instanceof FaceLandmarks68) {
                ...
                // drawContour(ctx, landmarks.getLeftEye(), true);
                // drawContour(ctx, landmarks.getRightEye(), true);
                centers = landmarks.getRefPointsForAlignment();
                points = [centers[0].x,centers[0].y,centers[1].x,centers[1].y];
                return;
            }
    ...
    exports.drawGlasses = drawGlasses;
